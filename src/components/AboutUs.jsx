...
const AboutUs = () => {
  return (
    <section className="flex flex-col lg:flex-row items-center gap-12 px-6 lg:px-20 py-20 bg-white ">
      {/* left image */}
      ...
      <div className="w-full lg:w-1/2 space-y-6" data-aos="fade-up" data-aos-delay="200">
        ...
        <p className="text-gray-600 leading-relaxed">
          At <strong>StreetRides</strong>, we believe in making every journey
